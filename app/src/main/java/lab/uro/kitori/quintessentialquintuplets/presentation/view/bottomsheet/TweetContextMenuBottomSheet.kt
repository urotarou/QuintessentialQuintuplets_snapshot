...
import lab.uro.kitori.quintessentialquintuplets.extension.share
...
class TweetContextMenuBottomSheet : BottomSheetDialogFragment() {
    companion object {
        ...
        fun newInstance(tweetUrl: String?, imageUrl: String?) = TweetContextMenuBottomSheet().apply {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.shareTweetMaskView.setOnClickListener {
            arguments?.getString(KEY_ARGUMENT_TWEET_URL)?.let { url ->
                context?.share(getString(R.string.share_tweet_title),
        ...
        binding.shareImageMaskView.setOnClickListener {
            arguments?.getString(KEY_ARGUMENT_IMAGE_URL)?.let { url ->
                context?.share(getString(R.string.share_image_title),
