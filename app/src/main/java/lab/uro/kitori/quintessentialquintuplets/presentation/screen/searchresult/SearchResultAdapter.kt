...
class SearchResultAdapter(
    ...
    companion object {
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Tweet>() {
            override fun areItemsTheSame(oldItem: Tweet, newItem: Tweet): Boolean = oldItem == newItem
    ...
    override fun getItemViewType(position: Int) = if (hasLoadingItem() && position == itemCount - 1) {
