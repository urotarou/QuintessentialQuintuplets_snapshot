...
class SearchResultActivity : AppCompatActivity() {
    companion object {
        ...
        fun createIntent(context: Context, heroine: Heroine) =
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(
            this,
            SearchResultViewModelFactory(application, getSelectedHeroine())
        )
    ...
    private fun initLayout() {
        ...
        binding.recyclerView.adapter =
            SearchResultAdapter(getSelectedHeroine(), object : TweetActionListener {
