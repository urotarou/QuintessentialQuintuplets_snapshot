...
class SelectActivity : AppCompatActivity() {
    ...
    private fun initLayout() {
        ...
        binding.ichikaButton.setOnClickListener {
            startActivity(SearchResultActivity.createIntent(this, Heroine.ICHIKA))
        }
        binding.ninoButton.setOnClickListener {
            startActivity(SearchResultActivity.createIntent(this, Heroine.NINO))
        }
        binding.mikuButton.setOnClickListener {
            startActivity(SearchResultActivity.createIntent(this, Heroine.MIKU))
        }
        binding.yotsubaButton.setOnClickListener {
            startActivity(SearchResultActivity.createIntent(this, Heroine.YOTSUBA))
        }
        binding.itsukiButton.setOnClickListener {
            startActivity(SearchResultActivity.createIntent(this, Heroine.ITSUKI))
        }
    }
}
